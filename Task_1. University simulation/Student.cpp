...
Student::Student(size_t students_identification, std::string students_family_name, std::string students_first_name, std::vector<Knowledge> students_set_of_knowledges){
